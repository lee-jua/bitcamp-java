...
public class Engine { 
	public static void main(String[] args) {
		...
		Dice dice = null;
		RPSGame rpsgame = null; //주소지가 없다, null 값이다 rpsgame을 reference
		//Kaup kaup = null;
		while (true) {
			...
			case 2 : 
				...
				case 6:
					//kaup = new Kaup();
						...
						new Kaup().setheight(scanner.nextDouble()/100);
						System.out.println("몸무게(kg)를 입력하세요.");
						new Kaup().setweight(scanner.nextDouble());
						String kaupresult = new Kaup().kaupcalculate();
						System.out.println("당신의 결과는 " + kaupresult+ "입니다.");
			}
